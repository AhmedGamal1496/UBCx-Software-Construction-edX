...
public class MovieGoerTest {
    ...
    @Test
    public void testBuyTicketNoUnderAgeException() throws ShowingFullException {
    ...
    @Test
    public void testBuyTicketNoShowingFullException() throws UnderAgeException {
